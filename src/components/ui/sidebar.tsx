...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0 is the fix: without it, `w-full` + `flex-1` on a flex
        // item fight over sizing and this refuses to shrink below its
        // children's preferred content width, pushing the whole sidebar
        // row wider than the viewport at the exact widths where the
        // sidebar is expanded but the viewport is still narrow (this was
        // a real, confirmed bug — 768–1024px overflowed by exactly the
        // sidebar's width before this fix).
